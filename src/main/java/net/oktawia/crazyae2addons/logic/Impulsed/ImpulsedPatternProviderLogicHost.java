...
public interface ImpulsedPatternProviderLogicHost extends PatternProviderLogicHost {
    ImpulsedPatternProviderLogic getLogic();
    ...
    default void returnToMainMenu(Player player, ISubMenu subMenu) {
        MenuOpener.returnTo(Menus.IMPULSED_PATTERN_PROVIDER_MENU, player, subMenu.getLocator());
    }
