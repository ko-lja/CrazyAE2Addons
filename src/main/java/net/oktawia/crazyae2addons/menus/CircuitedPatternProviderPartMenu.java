...
public class CircuitedPatternProviderPartMenu extends AEBaseMenu {
    ...
    public CircuitedPatternProviderPartMenu(int id, Inventory playerInventory, CircuitedPatternProviderLogicHost host) {
        super(Menus.CIRCUITED_PATTERN_PROVIDER_PART_MENU, id, playerInventory, host);
